    ...
    m_targetElapsedTicks(TicksPerSecond / 60)
{
    ...
    m_qpcMaxDelta = static_cast<uint64_t>(qpcFrequency.QuadPart / 10);
	m_qpcFrequency = qpcFrequency.QuadPart;
	m_qpcLastTime = qpcLastTime.QuadPart;
}
...
void Tick(const TUpdate& update)
{
    ...
    uint64_t timeDelta = currentTime.QuadPart - m_qpcLastTime;

    m_qpcLastTime = currentTime.QuadPart;

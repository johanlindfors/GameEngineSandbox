...
void SpriteScene::load()
{
    ...
    if(IOCContainer::instance().contains<SpriteRenderer>()) {
        ...
        resourceManager->loadTextures({ "spritesheet_default.png" });
    ...
    mSprite->texture = resourceManager->getTexture( "spritesheet_default.png" );
...
void SpriteScene::update(shared_ptr<IStepTimer> timer)
{
    ...
    {
        // TODO: Generate a new random monster
    }
}

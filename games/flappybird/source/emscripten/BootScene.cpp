...
void BootScene::load()
{
    ...
    const std::vector<std::string> resources = {
        ...
        "assets/textures/atlas.txt",
        "assets/textures/flappyfont.png",
        "assets/textures/flappyfont.fnt",
        "assets/textures/numbers.fnt",
        ...
        "assets/audio/ground-hit.wav",
        "assets/audio/ouch.wav",
        "assets/audio/pipe-hit.wav",

...
ParallaxBackground::ParallaxBackground()
    : mClouds(make_unique<Clouds>(Point<float>{0, 172}, Vector2{SCROLL_SPEED * 0.25f, 0})), mSkyline(make_unique<Skyline>(Point<float>{0, 133}, Vector2{SCROLL_SPEED * 0.5f, 0})), mTrees(make_unique<Trees>(Point<float>{0, 113}, Vector2{SCROLL_SPEED * 0.75f, 0})), mIsRunning(true)
{
}
